...
- 눈·비·낙엽·별·여러 색 별·하트·꽃잎·색종이·비눗방울·서로 충돌하며 튕기는 비눗방울·반딧불 효과 선택
- 사용자 헤더에서 클릭 한 번으로 효과 켜기·끄기
- 시작·종료 날짜와 매일 시간대 예약
- 매일·평일·주말 및 주요 지역 타임존 드롭다운 설정
...
예약을 사용하면 관리자 활성화와 예약 시간이 우선 적용됩니다. 예약 범위 안에서만 사용자의
개별 ON/OFF 선택이 반영되며, 종료 시간이 시작 시간보다 이르면 자정을 넘는 예약으로 처리합니다.
예를 들어 `22:00`~`06:00`은 밤 10시부터 다음 날 오전 6시까지 적용됩니다.
