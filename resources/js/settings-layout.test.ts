...
describe('plugin settings layout', () => {
    ...
    it('keeps schedule controls within plugin-owned equal padding', () => {
        ...
        expect(effectsCss).toContain('grid-template-columns: 1.5rem 2.25rem repeat(7, minmax(8.75rem, 1fr)) minmax(1.75rem, auto)');
        ...
        expect(effectsCss).toContain('::-webkit-calendar-picker-indicator');
